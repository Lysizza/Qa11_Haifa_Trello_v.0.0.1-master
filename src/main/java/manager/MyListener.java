...
public class MyListener extends AbstractWebDriverEventListener {
    ...
    public void afterFindBy(By by, WebElement element, WebDriver driver) {
        ...
        logger.info("End find element with 'locator' ---> "+by);
    ...
    public void onException(Throwable throwable, WebDriver driver) {
     ...
     //   logger.info("**************************************");
     // not understandable info -  logger.info("We have a throwable ---> "+throwable.getStackTrace().toString());
     //   logger.info("**************************************");
    ...
    //    logger.info("**************************************");
    // not understandable info    logger.info("We have a throwable ---> "+throwable.getSuppressed().toString());
    //    logger.info("**************************************");
